<?php include_once 'includes/templates/header.php';?>
    ...
    <section class="seccion contenedor">
        <h2 class="separador">Registro de usuarios</h2>
        <form id="registro" class="registro" action="validar_registro.php" method="POST">
            <div id="datos-usuarios" class="registro caja">
                        ...
                        <li>
                            <div class="tabla-precio">
                                ...
                                <div class="orden">
                                    ...
                                    <input type="number" min="0" id="pase_dia" name="boletos[]" placeholder="0">
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="tabla-precio">
                                ...
                                <div class="orden">
                                    ...
                                    <input type="number" min="0" id="pase_completo" name="boletos[]" placeholder="0">
                                </div>
                            </div>
                        </li>
                        <li>
                            <div class="tabla-precio">
                                ...
                                <div class="orden">
                                    ...
                                    <input type="number" min="0" id="pase_2dias" name="boletos[]" placeholder="0">
                                </div>
                            </div>
                        </li>
                    </ul>
                ...
                <div class="caja">
                    <div class="extras">
                        <div class="orden">
                            ...
                            <input type="number" min="0" id="camisa_evento" name="pedido_camisa" size="3" placeholder="0">
                        </div>
                        <div class="orden">
                            <label for="etiquetas">Paquete de 10 etiquetas $2 <small>(HTML5, CSS3 y JavaScript)</small></label>
                    ...
                    <div class="total">
                        ...
                        <input type="submit" id="boton-registro" name="submit" class="boton" value="Pagar">
                    </div>
                </div>
            </div>
        </form>
